...
function backgroundChangeB1() {
    ...
    var t = document.createTextNode("Oops, correct answer is 'Humayun'."); 
    h.appendChild(t); 
    ...
    btn.addEventListener("click", function() {
        window.open('file:///C:/Users/DELL/Desktop/MY%20projects/Project%204/Question%202/doc3.html');
        window.close('file:///C:/Users/DELL/Desktop/MY%20projects/Project%204/Question%201/doc2.html');
    })
}
...
function backgroundChangeB2() {
    ...
    var h = document.createElement("H1");
    var t = document.createTextNode("Hey, You got it right!"); 
    h.appendChild(t); 
    document.body.appendChild(h);  
    this.disabled = true; 
