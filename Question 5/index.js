...
function backgroundChangeB1() {
    ...
    var t = document.createTextNode("You're amazing!"); 
    h.appendChild(t); 
    ...
    btn.addEventListener("click", function() {
        window.open('file:///C:/Users/DELL/Desktop/MY%20projects/Project%204/Exit%20Page/index.html');
        window.close('file:///C:/Users/DELL/Desktop/MY%20projects/Project%204/Question%205/index.html');
    })
}
...
function backgroundChangeB2() {
    ...
    var h = document.createElement("H1");
    var t = document.createTextNode("No problem, Everyone makes mistakes"); 
    h.appendChild(t); 
    document.body.appendChild(h);  
    this.disabled = true; 
